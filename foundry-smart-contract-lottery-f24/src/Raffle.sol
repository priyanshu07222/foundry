...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    function enterRaffle() external payable {
        // require(msg.value >= i_entranceFee, "Not enough ETH sendt!");  (less gas efficient consume more gas)
        // require(msg.value >= i_entranceFee, Raffle__SendMoreToEnterRaffle); (good, but right now only work in specific version)
     ...
     * 4. Implicitly, your subscription have LINK
     * @param - ignored
    ...
    // 2. Use random number ot pick a player
